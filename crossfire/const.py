...
CRSF_FRAMETYPE_TLM_COMMAND = 0x40
...
def CRSF_FRAMETYPE_2_NAME(id):
    type_2_name = {
        ...
        CRSF_FRAMETYPE_TLM_COMMAND: "TLM CMD?",
...
def CRSF_ADDR_2_NAME(addr):
    addr_2_name = {
        ...
        CRSF_ADDRESS_VTX_ADD: "VTX ADD",
        CRSF_ADDRESS_RADIO_TRANSMITTER: "RADIO TRANSMITTER",
        CRSF_ADDRESS_CRSF_RECEIVER: "RC RX",
        CRSF_ADDRESS_CRSF_TRANSMITTER: "RC TX",
    }
